...
void DiskSchedulingPolicy::SCAN()
{
    ...
    else
    {
        ...
        // going to limit;
        totalHeadMovement += abs(currentHead - limit);
        orderOfProcessing[j] = limit;
        cout << "\t" << (++j) << "\t\t" << limit << "\t\t" << abs(currentHead - limit) << "\t\t" << totalHeadMovement << endl;
        currentHead = limit;
...
void DiskSchedulingPolicy::CSCAN()
{
    ...
    if (outer == 0)
    {
        ...
        totalHeadMovement += abs(currentHead - limit);
        orderOfProcessing[j] = limit;
        cout << "\t" << (++j) << "\t\t" << limit << "\t\t" << limit << "\t\t" << totalHeadMovement << endl;
        currentHead = limit;
    ...
    else
    {
        ...
        orderOfProcessing[j] = 0;
        cout << "\t" << (++j) << "\t\t" << 0 << "\t\t" << limit << "\t\t" << totalHeadMovement << endl;
        currentHead = 0;
